...
# Линейный интервал - распределение равномерно чисел
...
# Преобразование в другую фигуру массива

arr = np.arange(10, 50, 5)
print(arr)

# Преобразование массива в матрицу в форму 2,4
arr_2d = arr.reshape(2, 4)
print(arr_2d)

# 4. Создайте массив из 6 равномерно распределённых чисел от 0 до 1.
np_lspace = np.linspace(0, 1, 6)
print(np_lspace)
